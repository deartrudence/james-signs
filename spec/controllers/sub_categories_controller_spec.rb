...
RSpec.describe SubCategoriesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested sub_category as @sub_category" do
      sub_category = SubCategory.create! valid_attributes
      get :show, params: {id: sub_category.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested sub_category as @sub_category" do
      sub_category = SubCategory.create! valid_attributes
      get :edit, params: {id: sub_category.to_param}, session: valid_session
      expect(assigns(:sub_category)).to eq(sub_category)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SubCategory" do
        expect {
          post :create, params: {sub_category: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved sub_category as @sub_category" do
        post :create, params: {sub_category: invalid_attributes}, session: valid_session
        expect(assigns(:sub_category)).to be_a_new(SubCategory)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested sub_category" do
        sub_category = SubCategory.create! valid_attributes
        put :update, params: {id: sub_category.to_param, sub_category: new_attributes}, session: valid_session
        sub_category.reload
      ...
      it "assigns the requested sub_category as @sub_category" do
        sub_category = SubCategory.create! valid_attributes
        put :update, params: {id: sub_category.to_param, sub_category: valid_attributes}, session: valid_session
        expect(assigns(:sub_category)).to eq(sub_category)
      end
    ...
    context "with invalid params" do
      it "assigns the sub_category as @sub_category" do
        sub_category = SubCategory.create! valid_attributes
        put :update, params: {id: sub_category.to_param, sub_category: invalid_attributes}, session: valid_session
        expect(assigns(:sub_category)).to eq(sub_category)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested sub_category" do
      sub_category = SubCategory.create! valid_attributes
      expect {
        delete :destroy, params: {id: sub_category.to_param}, session: valid_session
      }.to change(SubCategory, :count).by(-1)
    end
